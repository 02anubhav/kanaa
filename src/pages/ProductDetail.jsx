      ...
      <div className="max-w-6xl mx-auto p-6 grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5">
          <img
            src={product.image}
            alt={product.title}
            className="w-full h-[200px] sm:h-[400px] object-cover rounded shadow-sm"
          />
        ...
        <div className="lg:col-span-5 space-y-4">
          ...
          <div className="flex items-center justify-between border border-dashed border-indigo-400 bg-indigo-50 p-3 rounded">
            ...
            <button className="bg-indigo-600 text-white px-4 py-2 rounded text-xs sm:text-sm">
              Signup Now
            </button>
          </div>

          {/* Coupon */}
          <div className="flex justify-between items-center w-3/4 sm:w-1/2 rounded-md px-3 py-2 gap-1 sm:gap-2 text-sm border border-neutral-300">
          ...
          <div className="flex items-center gap-3 mt-4">
            <button
              ...
              className="px-6 py-3 w-1/2 text-xs sm:text-sm bg-indigo-600 text-white rounded hover:opacity-95 cursor-pointer"
            >
              Add to Cart
            </button>
            <Link
